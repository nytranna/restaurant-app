...
/** source: /var/www/restaurant-app/app/UI/Post/show.latte */
final class Template_cf533c8af5 extends Latte\Runtime\Template
{
	public const Source = '/var/www/restaurant-app/app/UI/Post/show.latte';
...
';
		foreach ($comments as $comment) /* line 18 */ {
			echo '		<p><b>';
			$ʟ_tag[0] = '';
			if ($comment->email) /* line 19 */ {
				echo '<';
				echo $ʟ_tmp = 'a' /* line 19 */;
				$ʟ_tag[0] = '</' . $ʟ_tmp . '>' . $ʟ_tag[0];
				echo ' href="mailto:';
				echo LR\Filters::escapeHtmlAttr($comment->email) /* line 19 */;
				echo '">';
			}
			echo '
			';
		...
		<div>';
			echo LR\Filters::escapeHtmlText($comment->content) /* line 23 */;
			echo '</div>
';
...
<a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Edit:edit', [$post->id])) /* line 27 */;
