<?php
// source: /var/www/restaurant-app/config/common.neon
// source: /var/www/restaurant-app/config/services.neon
// source: array
...
class Container_e0b915e571 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Post\PostPresenter' => [2 => ['application.2']],
		...
		'App\UI\Edit\EditPresenter' => [2 => ['application.6']],
	...
	public function createServiceApplication__2(): App\UI\Post\PostPresenter
	{
	...
	public function createServiceApplication__6(): App\UI\Edit\EditPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/var/www/restaurant-app/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/var/www/restaurant-app/temp/cache');
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=restaurant-app',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/'mysql'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_e0b915e571 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/var/www/restaurant-app/temp/cache/latte');
